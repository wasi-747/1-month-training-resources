...
let inMemoryListings = [
  ...
  {
    _id: 'listing-uttara-1',
    title: '1 Seat in 2-Bed Bachelor Room (Opposite TechDojo, Road 6)',
    description:
      'Directly opposite TechDojo office on Road 6, Sector 4. Ideal for software interns, trainees, or IUBAT students. High-speed optic fiber WiFi, gas, maid service included.',
    rentAmount: 3600,
    area: 'Uttara',
    addressText: 'House 14, Road 6, Sector 4, Uttara (Opposite TechDojo)',
    location: {
      type: 'Point',
      coordinates: [90.4008, 23.8640],
    },
    propertyType: 'seat_rent',
    rentalCategory: 'seat',
    quantityAvailable: 1,
  ...
  {
    _id: 'listing-uttara-2',
    title: 'Furnished Single Room with Balcony (Road 4, Sector 6, Uttara)',
    description:
      'Well-ventilated single room with wide balcony in Sector 6. 2 minutes walk to TechDojo and Sector 6 Park. 24/7 water, WiFi, and cleaning maid.',
    rentAmount: 5800,
    area: 'Uttara',
    addressText: 'Road 4, Sector 6, Uttara (2 mins walk to TechDojo)',
    location: {
      type: 'Point',
      coordinates: [90.4015, 23.8648],
    },
    propertyType: 'single_room',
    rentalCategory: 'room',
    quantityAvailable: 1,
  ...
  {
    _id: 'listing-uttara-3',
    title: 'Bachelor Master Bed with Attached Bath (Sector 4, Near Jashimuddin Metro)',
    description:
      'Spacious master bedroom with personal attached bathroom and private balcony. Located near Jashimuddin Avenue & Metro Station, 5 mins walk to TechDojo.',
    rentAmount: 8200,
    area: 'Uttara',
    addressText: 'Road 8, Sector 4, Uttara (Near Jashimuddin Metro & Sector 4 Kalyan Samity)',
    location: {
      type: 'Point',
      coordinates: [90.3995, 23.8630],
    },
    propertyType: 'master_bed',
    rentalCategory: 'room',
    quantityAvailable: 1,
  ...
  {
    _id: 'listing-uttara-4',
    title: 'Female Student / Intern Sublet Room (Sector 6, Road 8, Uttara)',
    description:
      'Safe and peaceful sublet room for female student or tech trainee in a gated family building with 24/7 CCTV and security guard. Meal system available.',
    rentAmount: 6000,
    area: 'Uttara',
    addressText: 'Road 8, Sector 6, Uttara (Near Sector 6 Lake & High School)',
    location: {
      type: 'Point',
      coordinates: [90.4020, 23.8655],
    },
    propertyType: 'single_room',
    rentalCategory: 'sublet',
    quantityAvailable: 1,
  ...
  {
    _id: 'listing-uttara-5',
    title: 'Budget Partitioned Dining Bed for Tech Trainee (Sector 4, Road 11)',
    description:
      'Low-cost curtain partitioned bed space with study table, locker, and high-speed fiber internet. Non-smoker friendly bachelor flat.',
    rentAmount: 2600,
    area: 'Uttara',
    addressText: 'Road 11, Sector 4, Uttara (Near Sector 4 Park)',
    location: {
      type: 'Point',
      coordinates: [90.3990, 23.8622],
    },
    propertyType: 'dining_space',
    rentalCategory: 'dining_space',
    quantityAvailable: 1,
  ...
  {
    _id: 'listing-uttara-6',
    title: 'Full 3-Bed Bachelor Flat for Tech/Student Team (Sector 6 Main Road)',
    description:
      'Entire 3rd floor flat available for 4-6 IT professionals or university students. 3 large bedrooms, drawing, dining, 3 baths, 2 balconies, lift, generator.',
    rentAmount: 23000,
    area: 'Uttara',
    addressText: 'Sector 6 Main Road, Uttara (Near Sector 6 High School)',
    location: {
      type: 'Point',
      coordinates: [90.4025, 23.8665],
    },
    propertyType: 'full_flat',
    rentalCategory: 'full_flat',
    quantityAvailable: 1,
...
export const mockStore = {
  ...
  // 10. Delete Listing
  deleteListing: (id) => {
    const idx = inMemoryListings.findIndex((l) => l._id === id);
    if (idx !== -1) {
      const deleted = inMemoryListings.splice(idx, 1);
      return deleted[0];
    }
    return null;
  },
