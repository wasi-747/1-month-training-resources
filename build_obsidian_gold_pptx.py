...
def create_obsidian_gold_deck():
    prs = Presentation()
    prs.slide_width = Inches(13.333)
    prs.slide_height = Inches(7.5)
    blank_layout = prs.slide_layouts[6]

    # Color Tokens: Obsidian Gold & Matte Charcoal
    ...
    p2 = tf.add_paragraph()
    p2.text = "Full Architecture Breakdown: Semantic Layouts, Professional Git Workflows, Asynchronous Event Loop, DOM Event Delegation & Node.js Core."
    p2.font.size = Pt(15)
    ...
    for h, d in bullets_s4_r:
        ...
        ph.font.size = Pt(12.5)
        ph.font.bold = True
        ph.font.color.rgb = GOLD_PRIMARY
        ph.space_after = Pt(2)
    ...
    if os.path.exists(loop_img):
        s5.shapes.add_picture(loop_img, Inches(6.95), Inches(1.85), width=Inches(5.433))
    ...
    if os.path.exists(dom_img):
        s6.shapes.add_picture(dom_img, Inches(6.95), Inches(1.85), width=Inches(5.433))
    ...
    if os.path.exists(node_img):
        s7.shapes.add_picture(node_img, Inches(6.95), Inches(1.85), width=Inches(5.433))
    ...
    if os.path.exists(ui_img):
        s8.shapes.add_picture(ui_img, Inches(6.95), Inches(1.85), width=Inches(5.433))
    ...
    out_file = os.path.join(base_dir, "Week_1_Presentation_Obsidian_Gold.pptx")
    prs.save(out_file)
    print("SUCCESS: Obsidian Gold Presentation saved to", out_file)

if __name__ == "__main__":
    create_obsidian_gold_deck()
